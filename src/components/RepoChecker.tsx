...
import { Search, Shield, AlertTriangle, Lock, CheckCircle, ArrowDown, Key, Code, GitBranch } from "lucide-react";
  ...
  const FeatureCards = () => (
    <div className="grid md:grid-cols-3 gap-8 w-full max-w-6xl mx-auto">
      <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
        ...
        <p className="text-gray-400">Detect and prevent accidental exposure of API keys, tokens, and sensitive credentials</p>
      </div>
      <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
        <Code className="w-12 h-12 text-primary mb-4" />
        <h3 className="text-lg font-semibold mb-2">AI-Generated Code Review</h3>
        <p className="text-gray-400">Get instant feedback on code generated by Lovable, Bolt, Create, or other AI tools</p>
      </div>
      <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
        <GitBranch className="w-12 h-12 text-primary mb-4" />
        <h3 className="text-lg font-semibold mb-2">Best Practices</h3>
        <p className="text-gray-400">Ensure your AI-built applications follow security best practices and guidelines</p>
      </div>
    </div>
  );

  const PrivateRepoGuide = () => (
    <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700 mt-8 text-left">
      <h3 className="text-xl font-semibold mb-4">Scanning Private Repositories</h3>
      <div className="space-y-4">
        <p className="text-gray-300">To scan private repositories, you have two options:</p>
        <ol className="list-decimal list-inside space-y-3 text-gray-300">
          <li>Grant read-only access to CheckMyGitHub (recommended)
            <ul className="list-disc list-inside ml-6 mt-2 text-gray-400">
              <li>Most secure option</li>
              <li>Limited to specific repositories</li>
              <li>Can be revoked anytime</li>
            </ul>
          </li>
          <li>Use a personal access token
            <ul className="list-disc list-inside ml-6 mt-2 text-gray-400">
              <li>Create a token with minimal permissions</li>
              <li>Use read-only scope</li>
        ...
        <div className="mt-6 p-4 bg-yellow-500/10 rounded-lg">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-300">
            <li>Never share full repository access</li>
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-xl text-gray-300">
              Built specifically for developers using AI tools like Lovable, Bolt, and Create.
              Protect your API keys and ensure your AI-generated code follows security best practices.
            </p>
            <p className="text-gray-400">
              Join thousands of developers who trust us to keep their AI-built applications secure.
